...
%matches 2 matrix
load('imgfildata.mat');
[~,cc]=size(img);% ~nr linii cc-nr coloane
picture=imresize(img,[300 500]);%300x500pixeli
...
%elimina componentele care au mai putin de 30 de pixeli
